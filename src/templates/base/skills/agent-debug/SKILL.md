...
- DO NOT just look at the line where the error occurred. Use `grep_search` to find where the failing function is called, where the data originated, and how the state flows through the app. You must understand the _current structure_ of the feature before modifying it.
...
- Formulate a hypothesis explaining _why_ the error occurred.
